...
Django demo app for Deepgram Text Intelligence.
...
```
feat(django-text-intelligence): add diarization support
fix(django-text-intelligence): resolve WebSocket close handling
refactor(django-text-intelligence): simplify session endpoint
